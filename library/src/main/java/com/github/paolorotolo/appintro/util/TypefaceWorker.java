...
/**
 * Created by Javinator9889 (https://github.com/Javinator9889)
 * on 13/10/2018 @ https://github.com/Javinator9889/AppIntro
 * Class for containing the typeface object that must be used and also work
 * directly with it
 */
public class TypefaceWorker {
     ...
     *
     * @param typeface <p>a <b>String</b>, which is an URL to font found at
     *                 Assets folder
     */
     ...
     *
     * @return <p><b>boolean</b>:<b>true</b> if typeface stored, else
     * <b>false</b></p>
     */
    ...
    /**
     * Applies typeface to a given TextView object. If there is no typeface
     * provided, exits
     *
     * @param textToApplyTypeface <p>the TextView where the <b>Typeface</b>
     *                            will be applied - cannot be null</p>
     * @param context             <p>the <b>Context</b> where the
     *                            <b>TextView</b> is located -
     *                            cannot be null</p>
     * @throws NullPointerException <p>whether <b>TextView</b> or
     * <b>Context</b> are null</p>
     */
    public void setTextTypeface(TextView textToApplyTypeface, Context context) {
        if (textToApplyTypeface == null || context == null)
            throw new NullPointerException(String
                    .format("Cannot apply setTypeface(TextView " +
                                    "textToApplyTypeface, Context context) " +
                                    "on a null %s",
        ...
        if (mIsFontResource)
            textTypeface = ResourcesCompat.getFont(context,
                    (Integer) mTypefaceAttribute);
        else
            textTypeface = CustomFontCache.get((String) mTypefaceAttribute,
                    context);
     ...
     *
     * @return <p>typeface attribute that can be a String or Integer
     * (also it can be null)</p>
     */
    @Nullable
