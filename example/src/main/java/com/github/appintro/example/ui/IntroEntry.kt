...
import com.github.appintro.example.ui.custom.AnimatedDrawableIntro
...
val defaultEntries = listOf(
        ...
        IntroEntry(R.string.animated_drawable_intro_title, R.string.animated_drawable_intro, AnimatedDrawableIntro::class.java),
