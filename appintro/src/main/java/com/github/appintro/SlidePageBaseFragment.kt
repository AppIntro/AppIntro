...
abstract class SlidePageBaseFragment : Fragment(), SlideSelectionListener, SlideBackgroundColorHolder {

    private val logTAG = LogHelper.makeLogTag(SlidePageBaseFragment::class.java)
